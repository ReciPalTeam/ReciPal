    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4 sm:space-y-6 px-4">
        ...
        <p className="text-sm sm:text-base text-muted-foreground max-w-md">
          Save your favorite meals from your weekly plan by clicking the heart icon. They'll appear here for easy access.
        </p>
      </div>
    );
  }
                  ...
                  toggleFavorite({ recipeId: fav.recipe.id, isFavorite: true }, {
                    onSuccess: () => {
                      toast({
                        ...
                        description: `${fav.recipe.name} removed from your favorites.`,
                      });
                    },
                  });
                }}
