            ...
            {previewWeek && (
              <Card className="bg-muted/50 border-0 shadow-[0_0_8px_2px_rgba(0,0,0,0.15)] my-4">
                <CardContent className="p-4 flex flex-col items-center justify-center">
                  <p className="text-[24px] font-display font-bold text-recipal-deep-green text-center mb-3" style={{ textShadow: '1px 2px 3px rgba(0,0,0,0.15)' }}>Projected Daily Average</p>
